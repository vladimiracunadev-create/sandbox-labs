...
**Estado real:** 🟡 `building` — hay código y **7 comprobaciones automáticas**, sin levantarse bajo `bwrap` en CI · **Carpeta:** [`cases/08-ai-agent-tools/`](../../cases/08-ai-agent-tools) · **Puerto:** `8808`
...
Levanta el caso como producto en `127.0.0.1:8808`. `POST /api/run` acepta el
