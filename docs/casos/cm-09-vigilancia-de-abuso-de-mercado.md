...
**Estado real:** 🟠 `prototype` — hay código y escenarios que se ejecutan, **sin verificación en un entorno real** · **Módulo:** [`crates/sandbox-markets/src/cases/surveillance.rs`](../../crates/sandbox-markets/src/cases/surveillance.rs)
