...
**Estado real:** 🟡 `building` — hay código y **6 comprobaciones automáticas**, sin levantarse bajo `bwrap` en CI · **Carpeta:** [`cases/10-package-build/`](../../cases/10-package-build) · **Puerto:** `8810`
...
Levanta el caso como producto en `127.0.0.1:8810`. `POST /api/run` acepta el
