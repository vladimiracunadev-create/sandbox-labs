...
**Estado real:** 🟡 `building` — hay código y **8 comprobaciones automáticas**, sin levantarse bajo `bwrap` en CI · **Carpeta:** [`cases/15-supply-chain/`](../../cases/15-supply-chain) · **Puerto:** `8815`
...
Levanta el caso como producto en `127.0.0.1:8815`. `POST /api/run` acepta el
